...
class App(tk.Tk):
    def __init__(self):
        ...
        self.book_title_entry = ttk.Entry(full_window_frame, width=50)
        ...
        self.book_author_entry = ttk.Entry(full_window_frame, width=50)
        ...
        self.book_price_entry = ttk.Entry(full_window_frame, justify="right", width=20)
